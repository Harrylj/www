...
$(function() {
	...
	function loadMeinv() {
		...
		for(var i = 0; i < 10; i++) { //每次加载时模拟随机加载图片
			...
			*/
			html = $('<div class="list-goods box boy fl"><a href="detail.html"><div class="lg-img-div"><img class="img-100" src="images/' + 
			data + '.jpg" /></div></a><div class="lg-right"><div class="list-goods-footer "><span class="lg-bh">NO</span><span class="goods-index">31</span><br /><span class="lg-name">胡萝卜</span><div class="number-father fr"><div class="love-number">1</div></div><p>一不小心又被自己给帅醒了，怎么办..一不小心又被自己给帅醒了一不小心又被自己给帅醒了一不小心又被自己给帅醒了一不小心又被自己给帅醒了</p><button class="game-btn-send" type="button">送祝福</button></div></div><div class="clear"></div></div>').find(".game-btn-send").on('click', function() {
				touPiao(this)
			}).end();
			$minUl = getMinUl();
			$minUl.append(html);
