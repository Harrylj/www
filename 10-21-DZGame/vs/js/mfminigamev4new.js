...
(function(b, d, a) {
	...
	(b.index_12 = function(b, c, d) {
		...
		this.shape.graphics.f("#FFFFFF").s().p("摸1");
	...
	(b.index_9 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.f().s("#FFCC00").ss(8, 1, 1).p("摸2");
	...
	(b.index_18 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.f("#FFFFFF").s().p("摸3");
	...
	(b.index_16 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.f("#FFFFFF").s().p("摸4");
	...
	(b.元件1 = function(b, c, d) {
		this.initialize(b, c, d, {});
		this.shape = new a.Shape;
		this.shape.graphics.f().s("#FF9900").ss(2, 1, 1).p("摸5");
		this.shape_1 = new a.Shape;
		this.shape_1.graphics.f("#FFFF00").s().p("摸6");
		this.shape_2 = new a.Shape;
		this.shape_2.graphics.f().s("#FF9900").ss(2, 1, 1).p("摸7");
		this.shape_3 = new a.Shape;
		this.shape_3.graphics.f("#FFFF00").s().p("摸8");
		this.shape_4 = new a.Shape;
		this.shape_4.graphics.f().s("#FF9900").ss(2, 1, 1).p("摸9");
		this.shape_5 = new a.Shape;
		this.shape_5.graphics.f("#FFFF00").s().p("摸10");
		this.timeline.addTween(a.Tween.get({}).to({
			state: [{
				t: this.shape_1
			}, {
	...
	(b.apple_13 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -125.2, -68.1)).s().p("摸11");
	...
	(b.apple_11 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -74.2, -85.3)).s().p("摸13");
	...
	(b.apple_10 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -102.7, -56.8)).s().p("摸14");
	...
	(b.apple_9 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -16, -12.6)).s().p("摸15");
	...
	(b.apple_8 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -25.6, -73.5)).s().p("摸16");
	...
	(b.apple_7 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -47, -81.8)).s().p("摸17");
	...
	(b.apple_6 = function() {
		...
		this.shape =
			new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -27.4, -11.1)).s().p("摸18");
	...
	(b.apple_5 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -57.1, -34.3)).s().p("摸19");
	...
	(b.apple_4 = function() {
		this.initialize();
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -26, -42.5)).s().p("摸20");
	...
	(b.index_17 = function(c, d, e) {
		...
		this.shape = new a.Shape;
		this.shape.graphics.f("#FFFFFF").s().p("摸21");
		this.shape.setTransform(141.4, 46.2);
		this.shape_1 = new a.Shape;
		this.shape_1.graphics.f("#FFFFFF").s().p("摸22");
	...
	(b.index_15 = function(c,
		...
		this.shape = new a.Shape;
		this.shape.graphics.f("#FFFFFF").s().p("摸23");
		this.shape.setTransform(142.9, 45.4);
		this.shape_1 = new a.Shape;
		this.shape_1.graphics.f("#FFFFFF").s().p("摸24");
	...
	(b.index_8 = function(c, d, e) {
		...
		this.shape = new a.Shape;
		this.shape.graphics.f("#FFCC00").s().p("摸25");
	...
	(b.apple_2 = function(c, f, e) {
		...
		this.shape = new a.Shape;
		this.shape.graphics.bf(d.apple_17, null, new a.Matrix2D(1, 0, 0, 1, -93.2, -14.9)).s().p("摸26");
		this.shape.setTransform(40.8, -49.8);
		this.timeline.addTween(a.Tween.get(this.shape).to({
			_off: !0
		}, 1).wait(1));
		this.shape_1 = new a.Shape;
		this.shape_1.graphics.bf(d.apple_17, null, new a.Matrix2D(0.707, 0.707, -0.707, 0.707, 42.6, -53.2)).s().p("摸27");
	...
	(b.INTROUI = function() {
		...
		this.shape = new a.Shape;
		this.shape.graphics.f("#FFFFFF").s().p("摸30");
